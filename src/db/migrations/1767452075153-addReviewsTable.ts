...
export class AddReviewsTable1767452075153 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "review" ("id" SERIAL NOT NULL, "message" text DEFAULT 'Отзыв к врачу', "rating" integer DEFAULT '4', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "users" ADD "rating" numeric DEFAULT '4.85'`);
        await queryRunner.query(`ALTER TABLE "users" ADD "experience" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD "studyBuild" character varying(255)`);
