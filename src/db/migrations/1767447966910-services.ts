...
export class Services1767447966910 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."services_clinictype_enum" AS ENUM('therapy', 'neurology', 'orthopedics', 'ophthalmology', 'dentistry', 'pediatrics', 'diagnostics', 'other')`);
        await queryRunner.query(`CREATE TABLE "services" ("id" SERIAL NOT NULL, "title" character varying(150), "description" text, "timeWork" character varying(40), "recLike" integer DEFAULT '0', "recDeslike" integer DEFAULT '0', "clinicType" "public"."services_clinictype_enum" NOT NULL DEFAULT 'other', "price" numeric NOT NULL DEFAULT '2500', CONSTRAINT "PK_ba2d347a3168a296416c6c5ccb2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_clinictype_enum" AS ENUM('therapy', 'neurology', 'orthopedics', 'ophthalmology', 'dentistry', 'pediatrics', 'diagnostics', 'other')`);
        await queryRunner.query(`ALTER TABLE "users" ADD "clinicType" "public"."users_clinictype_enum" DEFAULT 'other'`);
        ...
        await queryRunner.query(`ALTER TABLE "service_doctors" ADD CONSTRAINT "FK_421f0ca6c1c1d592c33044782bc" FOREIGN KEY ("doctorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
